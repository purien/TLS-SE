...
%JDK%\bin\javac.exe .\im\im.java -classpath %CLASSPATH% 
...
%JDK%\bin\java -Djc.home=%JC% -classpath %JC_CLASSPATH% com.sun.javacard.converter.Main -classdir . -exportpath %JC%\api_export_files -i -out EXP CAP -applet 0x01:0x02:0x03:0x04:0x05:0x00  im.im  im  0x01:0x02:0x03:0x04:0x05 1.0
